...
import io.github.leadpony.fika.parser.markdown.block.matchers.ThematicBreakMatcher;
 ...
 * @author leadpony
 */
public class ThematicBreak implements FeatureProvider {

    @Override
    public Feature feature() {
        return BasicFeature.THEMATIC_BREAK;
    }

    @Override
    public void provide(ParserBuilder builder) {
        builder.add(new ThematicBreakMatcher());
    }
}
