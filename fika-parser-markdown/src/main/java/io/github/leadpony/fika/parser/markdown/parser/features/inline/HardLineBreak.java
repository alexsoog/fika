...
import io.github.leadpony.fika.parser.markdown.inline.handlers.BackslashLineBreakHandler;
import io.github.leadpony.fika.parser.markdown.inline.handlers.LineBreakHandler;
...
public class HardLineBreak implements FeatureProvider {
    ...
    public void provide(ParserBuilder builder) {
        builder.add(new LineBreakHandler());
        builder.add(new BackslashLineBreakHandler());
    }
}
