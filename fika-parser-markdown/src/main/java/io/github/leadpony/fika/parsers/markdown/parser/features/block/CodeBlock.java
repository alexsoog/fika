...
import io.github.leadpony.fika.parsers.markdown.block.matchers.FencedCodeMatcher;
import io.github.leadpony.fika.parsers.markdown.block.matchers.IndentedCodeMatcher;
...
public class CodeBlock implements FeatureProvider {
    ...
    public void install(BlockMatcherRegistry blockRegistry, InlineHandlerRegistry inlineRegistry) {
        blockRegistry.installBlockMatcher(new FencedCodeMatcher());
        blockRegistry.installBlockMatcher(new IndentedCodeMatcher());
    }
}
