...
import io.github.leadpony.fika.parser.markdown.block.matchers.HtmlBlockMatcher;
 ...
 * @author leadpony
 */
public class HtmlBlock implements FeatureProvider {

    @Override
    public Feature feature() {
        return BasicFeature.HTML_BLOCK;
    }

    @Override
    public void provide(ParserBuilder builder) {
        builder.add(new HtmlBlockMatcher());
    }
}
